...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'pub_date', :label => 'Publication Year', :single => true, :show => false
    config.add_facet_field 'subject_topic_facet', :label => 'Topic', :limit => 20, :show => false
